...
const CASE_STUDIES = [
  ...
  },
  {
    ...
    badge: '48–59% Growth',
    result: 'Embedded operations architect. Scaled client acquisition through organic and student network channels. Performance-only acquisition model.',
  ...
  },
  {
    ...
    badge: '6,000+ Members',
    result: 'Built from zero with ₹0 ad spend. 4 national hackathons. 30–40% budget surplus on every event. Company-sponsored non-profit ecosystem.',
